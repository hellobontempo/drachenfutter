...
def create_random_recipe 
    ...
    if !@recipe.present?
        @recipe = Recipe.create(title: api_recipe["strMeal"], instructions: api_recipe["strInstructions"], source: api_recipe["strSource"], photo: api_recipe["strMealThumb"], creator: User.find_by(name:"Admin"), category: api_recipe["strCategory"])
