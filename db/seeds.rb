...
Review.create(user: user1, content: "So delicious!", rating: 3, recipe: Recipe.find(1))
...
Review.create(user: user1, content: "My boyfriend dumped me after making him this!", rating: 1, recipe: Recipe.find(2))
